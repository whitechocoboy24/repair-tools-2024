@echo off
	...
	echo.                                        
	echo                       whitechocoboy24 detected %NameOS% %SP% %WinBuild%
	echo.                     __________________________________________________________
	echo.                    ^|                                                         ^|
	Echo.                    ^|   [1] Read_Me                                           ^|
	Echo.                    ^|_________________________________________________________^|
	Echo.                    ^|                                                         ^|
	Echo.                    ^|   [2] Activate Windows ^& Office                         ^| 
	Echo.                    ^|_________________________________________________________^|
	Echo.                    ^|                                                         ^|
	...
	Echo.                    ^|                                                         ^|
	Echo.                    ^|+++++++++++++++++++++++++++++++++++++++++++++++++++++++++^|
	Echo.                    ^|                  ~~ whitechocoboy24 ~~                  ^|
	Echo.                    ^|              ~~~only for exclusive users~~~             ^|
	Echo.                    ^|_________________________________________________________^|                      
	ECHO.
	choice /C:123456789 /N /M ".                   Enter Your Choice Number Here [1,2,3,4,5] : "
	...
	echo Project is supported only for Windows 7/8/10/11 and their Server equivalent.
	echo.
	echo Press any key to exit...
	pause >nul
	goto :eof
	...
	mode con cols=98 lines=90
	ECHO *********************************************************
	ECHO ***    whitechocoboy24 Detected Your Windows Status   ***
	ECHO *********************************************************
	...
	::===========================================================
	:CheckForUpdates
	start mailto:vikas.pro.unknown@gmail.com?subject=hello_whitechocoboy24&body=Are there any updates dude ?
	goto:MAINMENU
	::===========================================================
	:Exit
	cls
	...
	echo                             :::::::::::::::::::::::::::::::::::::
	echo                             ::                                 ::
	echo                             ::  Thanks to whitechocoboy24      ::
	echo                             ::                                 ::
	echo                             :::::::::::::::::::::::::::::::::::::
	echo.
	echo.
